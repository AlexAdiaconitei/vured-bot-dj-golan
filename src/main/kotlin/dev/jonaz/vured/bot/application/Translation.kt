...
object Translation {
    ...
    const val AUTOCOMPLETE_SPOTIFY_ALBUM = "$AUTOCOMPLETE_SPOTIFY_ALBUM_ICON%s - %s"
    const val AUTOCOMPLETE_YOUTUBE_ICON = "\uD83D\uDD34Youtube: "
    const val AUTOCOMPLETE_YOUTUBE = "$AUTOCOMPLETE_YOUTUBE_ICON%s"
}
